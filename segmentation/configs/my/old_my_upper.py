...
_base_ = [
    '../_base_/models/upernet_r50.py', '../_base_/datasets/my.py',
...
model = dict(
    ...
    backbone=dict(
        ...
        window_size=[None] * 12),
    decode_head=dict(num_classes=16, in_channels=[768, 768, 768, 768]),
    auxiliary_head=dict(num_classes=16, in_channels=768),
